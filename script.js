  ...
  if (recipientName) {
    ...
    // Countdown function
    function countdown() {
      const countDate = new Date("November 24, 2025 19:00:00").getTime();
...
function fetchUcapan() {
  var url = 'https://script.google.com/macros/s/AKfycbxwox5p-eXNXKdCCXlvtDy6uivSTBBROu9_uoESHjQYeg3Dh77W-EPbzDnnF5XzaLTL/exec'; // Ganti dengan URL Web App Google Apps Script Anda
...
document.getElementById('formPernikahan').addEventListener('submit', function(event) {
  ...
  fetch('https://script.google.com/macros/s/AKfycbxwox5p-eXNXKdCCXlvtDy6uivSTBBROu9_uoESHjQYeg3Dh77W-EPbzDnnF5XzaLTL/exec', {
    method: 'POST',
